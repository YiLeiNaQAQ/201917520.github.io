var config = {
    ...
    age: "21",
    phone: "123456789",
    email: "chenmingmimgr@foxmail.com",
    address: "现居河南省郑州市",
    qq: "111111111",
    log: "Happysnaker",
    ...
    welcome: "青青子衿，悠悠我心<br>" +
             "但为君故，沉吟至今<br>" +
             "你好，我是陈明明，华北水利水电大学软件工程大四在读生<br>" +
             "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>你好！我叫陈明明，性别男，华北水利水电大学信息工程学院大四在读。我期望的工作岗位是Java后端开发。</p>" +
    ...
    */  
     ...
     */
    icon: [
        ["./svg/github.svg", "https://github.com/YiLeiNaQAQ", "我的GitHub主页"],
    ],
